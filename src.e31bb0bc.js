...
var isEmailInputsValid = function isEmailInputsValid(input) {
  var emailRules = /^[^.@]+.*@.*[^.@]$/;
...
var isTelInputValid = function isTelInputValid(input) {
  console.log('start tel valid.');
  var phoneRules = /^\+?([0-9]{3})[-. ]?([0-9]{2})[-. ]?([0-9]{3})[-. ]?([0-9]{2})[-. ]?([0-9]{2})$/;
...
var validateForm = function validateForm(form) {
  var inputs = _toConsumableArray(form.querySelectorAll('.field__input'));

  form.addEventListener('submit', function (event) {
    var validationResult = inputs.map(function (input) {
      input.parentElement.classList.remove('field_success', 'field_invalid');
      var validationResult = isValidInput(input);
    ...
    if (!validationResult.every(function (result) {
      return result === true;
    })) {
...
(0, _form.validateForm)(form);
},{"./js/form":"js/form.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
